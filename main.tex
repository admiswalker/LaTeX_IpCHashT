...
\usepackage{caption}
\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, font=normalsize} %\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, font=footnotesize}
\renewcommand{\figurename}{\bf Figure} % \renewcommand{\figurename}{Fig.}
\captionsetup[table]{format=plain, labelformat=simple, labelsep=period, font=normalsize} % \captionsetup[table]{format=plain, labelformat=simple, labelsep=period, font={sc, footnotesize}}
