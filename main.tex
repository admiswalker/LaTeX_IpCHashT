...
\usepackage{caption}
\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, labelfont=bf, font=normalsize} %\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, font=footnotesize}
\renewcommand{\figurename}{Figure} % \renewcommand{\figurename}{Fig.}
\captionsetup[table]{format=plain, labelformat=simple, labelsep=period, labelfont=bf, font=normalsize} % \captionsetup[table]{format=plain, labelformat=simple, labelsep=period, font={sc, footnotesize}}
