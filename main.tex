%\documentclass[oneside,openright,uplatex]{jsbook} 
\documentclass[oneside,openany,uplatex]{jsbook}
%\documentclass[twoside,openright,uplatex]{jsbook}
%\documentclass[twoside,openany,uplatex]{jsbook}
%\documentclass[report,uplatex]{jsbook}
%\documentclass[openany,uplatex]{jsbook}
% oneside: 章ごとに改ページ．twoside: 章の初めが右側となるように改ページ．
...
\usepackage{color}   % {\bf \color{red}memo: }
...
\usepackage{caption}
\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, labelfont=bf, font=small} %\captionsetup[figure]{format=plain, labelformat=simple, labelsep=period, font=footnotesize}
\renewcommand{\figurename}{Figure} % \renewcommand{\figurename}{Fig.}
\captionsetup[table]{format=plain, labelformat=simple, labelsep=period, labelfont=bf, font=small} % \captionsetup[table]{format=plain, labelformat=simple, labelsep=period, font={sc, footnotesize}}
...
\definecolor{cBest}{gray}{0.90} % color best
\definecolor{cGood}{gray}{0.65} % color good
\definecolor{cMedi}{gray}{0.50} % color medium
\definecolor{cBad }{gray}{0.30} % color bad
