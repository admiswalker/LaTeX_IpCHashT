...
\begin{figure}[h]
  ...
  \caption{
    Total time of insertion using pre-allocated table.
    sstd::IpCHash (as maxLF50) and ska::flat\_hash\_map are rehashing around $4.1\textasciitilde2\times10^6$.
  }
...
\begin{figure}[h]
  ...
  \caption{
    Total time of insertion with rehashing table.
