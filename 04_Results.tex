...
\begin{figure}[h]
  \includegraphics[scale=0.24]{./fig_bench/maxLoadFactor.pdf}
  \caption{
...
\begin{figure}[h]
  \hspace{-1mm}
  \includegraphics[scale=0.24]{./fig_bench/usedMemory_wRehash_log.pdf}
  \caption{ Allocated memory size. }
  \label{fig_bench_memory}
\end{figure}

\begin{figure}[h]
  \includegraphics[scale=0.24]{./fig_bench/insert_et_preAlloc.pdf}
  \caption{ Total time of insertion using pre-allocated table. }
  \label{fig_bench_insert_preAlloc}
\end{figure}

\begin{figure}[h]
  \includegraphics[scale=0.24]{./fig_bench/insert_et_wRehash.pdf}
...
\begin{figure}[h]
  \hspace{-3mm}
  \includegraphics[scale=0.24]{./fig_bench/insert_wRehash.pdf}
...
\begin{figure}[h]
  \hspace{-3mm}
  \includegraphics[scale=0.24]{./fig_bench/find_wRehash.pdf}
...
\begin{figure}[h]
  \hspace{-3mm}
  \includegraphics[scale=0.24]{./fig_bench/find_wRehash_failedAll.pdf}
...
\begin{figure}[h]
  \hspace{-3mm}
  \includegraphics[scale=0.24]{./fig_bench/erase_wRehash.pdf}
