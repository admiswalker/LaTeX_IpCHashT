...
\section{削除}
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_26.pdf}
  \caption{
    Deletion case01.
  }
...
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_28.pdf}
  \caption{
    Deletion case02.
  }
...
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_30.pdf}
  \caption{
    Deletion case03.
  }
...
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_32.pdf}
  \caption{
    Deletion case04.
  }
...
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_34.pdf}
  \caption{
    Deletion case05.
  }
...
\begin{figure}[h]
  \includegraphics[scale=0.73]{./figs_algo/algorism_crop_36.pdf}
  \caption{
    Deletion case06.
  }
  \label{fig_IpCHashT_deletion_case05}
