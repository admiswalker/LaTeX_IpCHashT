...
\begin{figure}[h]
\begin{center}
  \includegraphics[page=2, scale=0.75]{./figs/algorism_crop.pdf}
\end{center}
\end{figure}

\begin{center}
  \begin{figure}[h]
    \includegraphics[page=3, scale=0.75]{./figs/algorism_crop.pdf}
    \caption{
      discription.
    }
...
\begin{figure}[h]
\begin{center}
  \includegraphics[page=4, scale=0.75]{./figs/algorism_crop.pdf}
\end{center}
\end{figure}
\begin{center}
  \begin{figure}[h]
    \includegraphics[page=5, scale=0.75]{./figs/algorism_crop.pdf}
    \caption{
      discription.
    }
    \label{fig_IpCHashT_XXXX}
