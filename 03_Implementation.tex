...
\begin{table}[hbtp]
  \begin{center}
    ...
    \begin{tabular}{ccc} \hline
      File name                  & Description                                  & Origin \rule[0pt]{0pt}{10pt} \\ \hline
      ...
      FNV\_Hash.cpp              & Light claculation weight hash function       & \url{qiita.com/Ushio/items/a19083514d087a57fc72} \\
      FNV\_Hash.hpp              & Light claculation weight hash function       & \url{qiita.com/Ushio/items/a19083514d087a57fc72} \\
      ...
      flat\_hash\_map-master.zip & Inplimentation of "ska::flat\_hash\_map"     & \url{github.com/skarupke/flat_hash_map} \\
      googletest-master.zip      & Google's C++ test framework                  & \url{github.com/google/googletest} \\
      plots.py                   & Plotting funcrions for benchmark             & \\
      sparsehash-master.zip      & Inplimentation of "google::dense\_hash\_map" & \url{github.com/sparsehash/sparsehash} \\
      sstd.zip                   & Convenient functions set                     & \url{github.com/admiswalker/SubStandardLibrary-SSTD-} \\
