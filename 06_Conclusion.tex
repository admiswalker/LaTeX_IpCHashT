...
{\bf sstd::IpCHashT (as uint16, maxLF100 and successful lookup major option)} は，最も高いメモリ効率を示し，
Successful lookup の区間 $10^5〜10^8.3$ において，安定した性能を示す．
{\bf sstd::IpCHashT (as uint16,maxLF100 and unsuccessful lookup major option)} は，最も高いメモリ効率を示し，
Unsuccessful lookup の区間 $10^7〜10^8.3$ で最も優れた結果を出す．
