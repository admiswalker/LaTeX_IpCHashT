...
\begin{table}%[hbtp]
  \begin{center}
    ...
    \begin{tabular}{c|c|ccc|ccc|c|c} \hline
        Implementation of                       & Insert                & \multicolumn{3}{c|}{\begin{tabular}{c}Successful lookup\end{tabular}}    & \multicolumn{3}{c|}{\begin{tabular}{c}Unsuccessful lookup\end{tabular}}       & Erase                   & Memory                \rule[0pt]{0pt}{15pt} \\
...
%        IpCHashT $_{\rm SL\ Opt.}^{\rm ^{u8, maxLF50}}$  & \cellcolor{cGood}good  & \cellcolor{cBest}best   & \cellcolor{cBest}best   & \cellcolor{cBad }bad  & \cellcolor{cGood}good   & \cellcolor{cMedi}medium & \cellcolor{cMedi}medium  & \cellcolor{cMedi}medium & \cellcolor{cBad }bad  \rule[0pt]{0pt}{15pt} \\
        IpCHashT (u8-LF50-S) & \cellcolor{cGood}good  & \cellcolor{cBest}best   & \cellcolor{cBest}best   & \cellcolor{cBad }bad  & \cellcolor{cGood}good   & \cellcolor{cMedi}medium & \cellcolor{cMedi}medium  & \cellcolor{cMedi}medium & \cellcolor{cBad }bad  \rule[0pt]{0pt}{15pt} \\
%        IpCHashT $_{\rm USL\ Opt.}^{\rm ^{u8, maxLF50}}$  & \cellcolor{cGood}good & \cellcolor{cBest}best   & \cellcolor{cGood}good   & \cellcolor{cBad }bad  & \cellcolor{cBest}best   & \cellcolor{cBest}best   & \cellcolor{cMedi}medium  & \cellcolor{cMedi}medium & \cellcolor{cBad }bad  \rule[0pt]{0pt}{15pt} \\
        IpCHashT (u8-LF50-U) & \cellcolor{cGood}good & \cellcolor{cBest}best   & \cellcolor{cGood}good   & \cellcolor{cBad }bad  & \cellcolor{cBest}best   & \cellcolor{cBest}best   & \cellcolor{cMedi}medium  & \cellcolor{cMedi}medium & \cellcolor{cBad }bad  \rule[0pt]{0pt}{15pt} \\
%        IpCHashT $_{\rm SL\ Opt.}^{\rm ^{u16, maxLF100}}$ & \cellcolor{cBad }bad  & \cellcolor{cBad }bad    & \cellcolor{cGood}good   & \cellcolor{cGood}good & \cellcolor{cBad }bad    & \cellcolor{cBad }bad    & \cellcolor{cGood}good    & \cellcolor{cBad }bad    & \cellcolor{cBest}best \rule[0pt]{0pt}{15pt} \\
