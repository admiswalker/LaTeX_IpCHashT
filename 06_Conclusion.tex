...
\begin{table}[hbtp]
  \begin{center}
    ...
    \begin{tabular}{c|c|ccc|ccc|c|c} \hline
        ...
        IpCHashT $_{\rm SL\ Opt.}^{\rm ^{u8, maxLF50}}$  & \cellcolor{gray090}good  & \cellcolor{gray100}best   & \cellcolor{gray100}best   & \cellcolor{gray050}bad  & \cellcolor{gray090}good   & \cellcolor{gray070}medium & \cellcolor{gray070}medium & \cellcolor{gray070}medium & \cellcolor{gray050}bad  \rule[0pt]{0pt}{15pt} \\
        IpCHashT $_{\rm USL\ Opt.}^{\rm ^{u8, maxLF50}}$  & \cellcolor{gray090}good & \cellcolor{gray100}best   & \cellcolor{gray090}good   & \cellcolor{gray050}bad  & \cellcolor{gray100}best   & \cellcolor{gray100}best   & \cellcolor{gray070}medium & \cellcolor{gray070}medium & \cellcolor{gray050}bad  \rule[0pt]{0pt}{15pt} \\
        IpCHashT $_{\rm SL\ Opt.}^{\rm ^{u16, maxLF100}}$ & \cellcolor{gray050}bad  & \cellcolor{gray050}bad    & \cellcolor{gray090}good   & \cellcolor{gray090}good & \cellcolor{gray050}bad    & \cellcolor{gray050}bad    & \cellcolor{gray090}good   & \cellcolor{gray050}bad    & \cellcolor{gray100}best \rule[0pt]{0pt}{15pt} \\
        dense\_hash\_map                        & \cellcolor{gray090}good & \cellcolor{gray090}good   & \cellcolor{gray070}medium & \cellcolor{gray100}best & \cellcolor{gray050}bad    & \cellcolor{gray050}bad    & \cellcolor{gray070}medium & \cellcolor{gray100}best   & \cellcolor{gray090}good \rule[0pt]{0pt}{15pt} \\
