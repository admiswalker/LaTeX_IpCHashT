...
まず，{\bf google::dense\_hash\_map}は，最大 load factor 50 \% であるから，
\begin{eqnarray*}
  ...
  &=& 16 \times ({\rm elements} / 0.5) {\rm\ [Byte]}\\
...
\begin{eqnarray*}
  ...
  &=& 18 \times ({\rm elements} / 0.5) {\rm\ [Byte]}\\
  &=& 36 \times {\rm elements} {\rm\ [Byte]}
\end{eqnarray*}
となる．{\bf sstd::IpCHashT (uint16)}は，
\begin{eqnarray*}
...
IpCHashT の uint8 2 つ分のアラインメントが uint64 境界に合致するように，
パディングされていると考えられる．
したがって，
